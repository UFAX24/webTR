...
USER_AGENT_LIST = json.loads(open('config.json', 'r').read())
...
def headers_list():
    ...
    """
    random_user_agent = random.choice(USER_AGENT_LIST["user_agents"])
...
def do_request(url):
    ...
    # for header in USER_AGENT_LIST['user_agents']:
    #     headers = {'user-agent': header}
    #     debug_print(str(headers))

    # for header_list in USER_AGENT_LIST['user_agents']:
    US_AGENT = headers_list()
